...
export default function ClaimableTasksColumn({ onClaimed }: { onClaimed?: () => void }) {
  ...
  // Don't render if no claimable tasks
              ...
              >
                <div className="px-2.5 py-2 bg-parchment/20">
                  <div className="flex items-center justify-between gap-1">
                    ...
                    {rate != null && (
                      <span className="shrink-0 px-1.5 py-0.5 rounded-full text-[9px] font-semibold bg-emerald-100 text-emerald-700">
                  ...
                  <button
                    ...
                    disabled={isClaiming}
                    className="mt-1.5 w-full px-3 py-1.5 rounded-lg bg-terracotta text-white text-[11px] font-semibold hover:bg-[#c4573a] disabled:opacity-50 cursor-pointer transition-colors"
                  >
