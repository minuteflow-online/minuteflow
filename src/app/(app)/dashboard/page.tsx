...
import { hasBroadAdminAccess, hasAdminPanelAccess } from "@/lib/financialAccess";
      ...
      {(() => {
        ...
        return (
          <div className={`grid gap-5 mb-6 ${gridClass}`}>
            ...
            {/* TEMP FOR TESTING (2026-09-11, requested by Neil in chat): widened
                from hasModerationAccess to hasAdminPanelAccess so a Specialist/IT
                account can see and test the dashboard's Admin tab before it
                ships. Revert to hasModerationAccess(profile) once confirmed
                working — matching TEMP comments in the two /api/admin/conversations
                route files. */}
            {userId && <DashboardMessagePanel currentUserId={userId} canModerate={hasAdminPanelAccess(profile)} />}
